...
export default function TagsPage() {
  const { tags, searchTerm, setSearchTerm, setIsModalOpen, setModalMode, setSelectedItem, handleDelete } = useContext(DataContext);
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Управление тегами</h1>
          <p className="text-gray-600">Управление тегами новостей</p>
        </div>
        <button
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {tags
          ...
          .map(tag => (
            <div key={tag.id} className="bg-white rounded-2xl shadow-md border border-gray-100 hover:shadow-lg transition-shadow p-6">
